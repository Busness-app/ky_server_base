...
- `KY_BACKUP_DEPOSIT_INTERVAL` is a Go duration (default `24h`) between scheduled KyRecovery deposits; `0` disables the schedule, anything else below `MinDepositInterval` (15m) or negative fails startup.
